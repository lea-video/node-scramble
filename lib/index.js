class Rand {
  constructor(maximum, seed, outOffset, loop = false) {
    ...
    this.seed = seed;
    this._start = Math.abs((seed % this.maximum) || 1);
    ...
    this._outOffset = (outOffset || 0) % this.maximum;
  ...
  current() {
    return this.n !== -1 ? Rand._offset(this._cur, this._outOffset, this.maximum) : -1;
  }
