class Rand {
  constructor(maximum, seed, outOffset, loop = false) {
    ...
    this.seed = seed;
    this._start = (Rand._wrappingMod(seed, this.maximum) + 1) || 1;
    ...
    this._outOffset = Rand._wrappingMod(outOffset, this.maximum) || 0;
...
// Func to mod and increase negative numbers by b to always produce positive int
Rand._wrappingMod = (a, b) => {
  let n = a % b;
  if (n < 0) n += b;
  return n;
};
// Simple offset, not requiring modulo
